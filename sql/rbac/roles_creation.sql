...
-- App role
GRANT USAGE ON WAREHOUSE ADA_COMPUTE TO ROLE app_role;
GRANT USAGE ON DATABASE HEALTH_APP TO ROLE app_role;
GRANT USAGE ON SCHEMA HEALTH_APP.COMMON TO ROLE app_role;
GRANT USAGE ON SCHEMA HEALTH_APP.RAW TO ROLE app_role;
GRANT USAGE ON SCHEMA HEALTH_APP.STAGING TO ROLE APP_ROLE;

GRANT USAGE ON FUTURE FUNCTIONS IN SCHEMA HEALTH_APP.COMMON TO ROLE APP_ROLE;
GRANT USAGE ON FUTURE PROCEDURES IN SCHEMA HEALTH_APP.COMMON TO ROLE app_role;
GRANT READ ON FUTURE STAGES IN SCHEMA HEALTH_APP.COMMON TO ROLE APP_ROLE;
GRANT SELECT ON FUTURE STREAMS IN SCHEMA HEALTH_APP.COMMON TO ROLE app_role;
